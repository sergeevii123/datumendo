...
const {
  ...
  NEXT_PUBLIC_MAINNET_GREENFIELD_RPC_URL,
  NEXT_PUBLIC_MAINNET_GREEN_CHAIN_ID,
...
export const GREENFIELD_MAINNET_RPC_URL = NEXT_PUBLIC_MAINNET_GREENFIELD_RPC_URL;
export const GREEN_MAINNET_CHAIN_ID = parseInt(NEXT_PUBLIC_MAINNET_GREEN_CHAIN_ID);
